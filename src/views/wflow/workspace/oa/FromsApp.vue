<template>
  <div v-loading="loading" class="w-page-body">
    ...
    <el-row :gutter="20">
      ...
      <el-col  :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
        <div class="count" @click="to('我发起的', 'submit')">
          <div>
            <p>我发起的</p>
      ...
      <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
        <div class="count" @click="to('关于我的', 'cc')">
          <div>
            <p>关于我的</p>
...
<script>
import {getGroupModelsByUser, getProcessCountData} from '@/api/wflow/modelGroup'
...
export default {
  ...
  methods: {
    ...
    to(title, path){
      this.$tab.openPage( title, '/wflow/' + path)
    },
    enterItem(item) {
