<script>
//导入所有节点组件
import Approval from '@/views/wflow/common/process/nodes/ApprovalNode.vue'
import Cc from '@/views/wflow/common/process/nodes/CcNode.vue'
import Concurrent from '@/views/wflow/common/process/nodes/ConcurrentNode.vue'
import Condition from '@/views/wflow/common/process/nodes/ConditionNode.vue'
import Trigger from '@/views/wflow/common/process/nodes/TriggerNode.vue'
import Delay from '@/views/wflow/common/process/nodes/DelayNode.vue'
import Empty from '@/views/wflow/common/process/nodes/EmptyNode.vue'
import Root from '@/views/wflow/common/process/nodes/RootNode.vue'
import Node from '@/views/wflow/common/process/nodes/Node.vue'
    ...
    addBranchNode(node){
      if (node.branchs.length < 8){
        node.branchs.push({
          ...
          props: Process.isConditionNode(node) ? this.$deepCopy(DefaultProps.CONDITION_PROPS):{},
